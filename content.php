...
?>
<form method="post">
    Date: <input type="number" min="7" max="60" id="dateRange" name="dateRange" value="14"><br>
    Minimum Nights Stay: <input type="number" min="1" max="5" id="NightsStay" name="NightsStay" value="1"><br>
    <input type="submit">
</form>
<?php
